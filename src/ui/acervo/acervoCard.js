        ...
        <article class="card acervo-item-card" aria-label="Item do acervo: ${safeDesc.replace(/"/g, '&quot;')}">
            <div class="card-image">
                <figure class="image is-square">
                    <img src="${item.imageUrl}" data-fallback-src="${item.originalImageUrl || ''}" alt="${safeDesc.replace(/"/g, '&quot;')}" loading="lazy" onerror="const f=this.dataset.fallbackSrc;if(f){this.removeAttribute('data-fallback-src');this.src=f;}" />
